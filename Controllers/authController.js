...
var Auth = {
  login: async function (req, res, next) {
    try {
      const query = {
        contact_no: req.body.num,
        password: req.body.pass,
        role: req.body.cat,
      };
      console.log(query)
      var manager = await User.find(query).lean();
  ...
  loginWithPassword: async function (req, res, next) {
    try {
              ...
              <tr>
                ...
                <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 580px; padding: 10px; width: 580px;">
                  <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 580px; padding: 10px;">
                    ...
                    <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Claraa health.</span>
