...
function sendSms(type, data, phoneNumber, countryCode) {
    ...
    switch (type) {
        case smsConstants.NEW_REGISTER_DOCTOR: {
            text = `Hello ${data.name}, thank you for registering with Velar Health. We will soon review and verify your account.`
            break;
        }
        case smsConstants.APPOINTMENT_NEW: {
            text = `Hello ${data.name}, thank you for making an appointment with Velar Health. We will soon get back to you.`
            break;
        }
